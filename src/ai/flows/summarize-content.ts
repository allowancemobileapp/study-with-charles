...
const SummarizeContentOutputSchema = z.object({
  ...
  imageUrl: z.string().optional().describe("An optional URL to an image generated by the AI, if relevant to the result.") // Changed from .url().optional()
});
...
- Present your solution in a well-structured document or report format. This means using clear headings if appropriate, and providing comprehensive answers/solutions.
...
Ensure the JSON syntax is perfect, including correct use of quotes for all keys and string values, commas between objects (but not after the last object in the array), and proper brackets and braces.`;
      ...
      // This case should ideally be prevented by form validation before calling the action.
    ...
    try {
      ...
      if (e instanceof Error) {
        ...
        errorMessage = `AI flow failed: ${e.message}`; // This message might be long, handled in action.ts
      ...
      // Throw the original error or a new error with the specific message
      // If e is already an Error, just rethrow it. Otherwise, wrap it.
